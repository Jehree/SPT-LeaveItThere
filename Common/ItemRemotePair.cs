...
namespace PersistentItemPlacement.Common
{
    internal class ItemRemotePair
    {
        ...
        public ItemRemotePair(ObservedLootItem lootItem, RemoteInteractableComponent remoteInteractableComponent, Vector3 placementPosition, Quaternion placementRotation, bool placed)
        {
            LootItem = lootItem;
